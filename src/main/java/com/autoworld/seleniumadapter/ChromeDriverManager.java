...
public class ChromeDriverManager extends DriverManager {
    ...
    private static final String HEADLESS_FLAG = System.getProperty("headless", ConfigProvider.getAsString("headless"));
    ...
    public void createDriver() {
        ...
        String[] values;
        if (HEADLESS_FLAG.equalsIgnoreCase("true")) {
            ...
            if (StringUtils.isNoneEmpty(this.downloadPath)) {
