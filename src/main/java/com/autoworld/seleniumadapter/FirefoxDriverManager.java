...
public class FirefoxDriverManager extends DriverManager {
    ...
    private static final String FIREFOX_CAPS = System.getProperty("ff.caps.list.of.string", ConfigProvider.getAsString("ff.caps.list.of.string"));
    ...
    public void createDriver() {
        ...
        if (this.bsFlag && this.seleniumGridFalg) {
            if (!FIREFOX_CAPS.isEmpty() && FIREFOX_CAPS.contains("||")) {
                String[] arr = FIREFOX_CAPS.split(Pattern.quote("||"));
